...
<template>
    ...
    >
            ...
            >
                ...
                >
                    <h1
                        ...
                        "
                    >
                        Ein holistischer Blick auf Desinformation
                    </h1>
                    <p class="sm:text-xl">
        ...
        <div
            v-else-if="slide == 2"
            key="2"
            class="w-screen min-h-screen flex flex-col sm:flex-row"
        >
            <div class="flex flex-col sm:w-1/2 pt-10 pl-8">
                <h3 class="slide-sub-headline">
                    Ein holistischer Blick auf Desinformation
                </h3>
                <h2 class="slide-headline">
                    Der systemische Kontext von Desinformation
                </h2>
            ...
            <div class="sm:w-1/2 h-full p-10 flex items-center justify-center">
                <img
                    class="w-full h-full"
                    src="@/assets/pictures/intro/overview.svg"
                />
            </div>
        </div>
        <div
        ...
        <div v-else-if="slide == 5" class="w-screen min-h-screen flex flex-col">
        ...
        <div
            v-else-if="slide == 6"
            class="w-screen min-h-screen flex flex-col pl-8 pt-10"
        >
            <div>
                <h3 class="slide-sub-headline">
                    Ein holistischer Blick auf Desinformation
            ...
            <div class="flex flex-col lg:flex-row flex-grow pb-8">
                <div class="flex flex-col justify-between lg:w-1/3">
                    <p class="mb-8 text-justify pr-8 lg:pr-0">
